...
$VaultName = "RecoveryServices-eastus2" #fetch automatically
$Subscription = "Azure CSU Internal Subscription JOSCOT" #fetch automatically
$ResourceGroup = "AzFileSync-rg" #fetch automatically
$SubscriptionId = "6956ed15-2e18-4b8e-9db7-6a61647dedfb" #fetch automatically
